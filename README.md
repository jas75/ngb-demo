...
> An Angular starter kit featuring [Angular 9](https://angular.io), [Ahead of Time Compile](https://angular.io/docs/ts/latest/cookbook/aot-compiler.html), [Router](https://angular.io/docs/ts/latest/guide/router.html), [Forms](https://angular.io/docs/ts/latest/guide/forms.html),
...
### Quick start
**Make sure you have Node version >= 12.0 and (NPM >= 5 or [Yarn](https://yarnpkg.com) )**
